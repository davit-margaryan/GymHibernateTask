...
public class TraineeProfileHealthIndicatorTest {

    @Mock
    private RestTemplate restTemplate;

    @InjectMocks
    private TraineeProfileHealthIndicator traineeProfileHealthIndicator;
